...
function defineShips(Action) {
    ...
    fuelShip.drag = 0.05;
    fuelShip.actionPool = [Action.buildTest, Action.MineRock, Action.DropItem, Actions.SwapSlots];
    ...
    debugShip.drag = 0.5;
    debugShip.actionPool = [Action.buildTest, Action.MineRock, Action.DropItem, Actions.SwapSlots];
    ...
    hackerShip.drag = 0.5;
    hackerShip.actionPool = [Action.buildTest, Action.MineRock, Action.DropItem, Actions.SwapSlots];
